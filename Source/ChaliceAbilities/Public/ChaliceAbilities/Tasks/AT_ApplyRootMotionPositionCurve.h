...
#include "AT_ApplyRootMotionPositionCurve.generated.h"


DECLARE_DYNAMIC_MULTICAST_DELEGATE(FApplyRootMotionPositionCurveDelegate);

UCLASS()
class CHALICEABILITIES_API UAbilityTask_ApplyRootMotionPositionCurve : public UAbilityTask_ApplyRootMotion_Base
{
	GENERATED_BODY()
