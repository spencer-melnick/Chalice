...
#include "RootMotionSource_PositionCurve.generated.h"
 ...
 */
USTRUCT()
struct CHALICECORE_API FRootMotionSource_PositionCurve : public FRootMotionSource
{
    GENERATED_BODY()
